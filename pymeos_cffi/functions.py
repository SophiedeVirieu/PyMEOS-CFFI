...
def interval_make(years: int, months: int, weeks: int, days: int, hours: int, mins: int, secs: float) -> 'Interval *':
...
def add_interval_interval(interv1: 'const Interval *', interv2: 'const Interval *') -> 'Interval *':
    interv1_converted = _ffi.cast('const Interval *', interv1)
    interv2_converted = _ffi.cast('const Interval *', interv2)
...
def datespan_make(lower: 'DateADT', upper: 'DateADT', lower_inc: bool, upper_inc: bool) -> 'Span *':
...
def geoset_srid(s: 'const Set *') -> 'int32_t':
    s_converted = _ffi.cast('const Set *', s)
...
def dateset_shift_scale(s: 'const Set *', shift: int, width: int, hasshift: bool, haswidth: bool) -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
...
def datespan_shift_scale(s: 'const Span *', shift: int, width: int, hasshift: bool, haswidth: bool) -> 'Span *':
    s_converted = _ffi.cast('const Span *', s)
...
def datespanset_shift_scale(ss: 'const SpanSet *', shift: int, width: int, hasshift: bool, haswidth: bool) -> 'SpanSet *':
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def geoset_set_srid(s: 'const Set *', srid: 'int32_t') -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
...
def geoset_transform(s: 'const Set *', srid: 'int32_t') -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
    srid_converted = _ffi.cast('int32_t', srid)
...
def geoset_transform_pipeline(s: 'const Set *', pipelinestr: str, srid: 'int32_t', is_forward: bool) -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
    pipelinestr_converted = pipelinestr.encode('utf-8')
    srid_converted = _ffi.cast('int32_t', srid)
    result = _lib.geoset_transform_pipeline(s_converted, pipelinestr_converted, srid_converted, is_forward)
    _check_error()
    return result if result != _ffi.NULL else None
...
def point_transform(gs: 'const GSERIALIZED *', srid: 'int32_t') -> 'GSERIALIZED *':
...
def point_transform_pipeline(gs: 'const GSERIALIZED *', pipelinestr: str, srid: 'int32_t', is_forward: bool) -> 'GSERIALIZED *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    pipelinestr_converted = pipelinestr.encode('utf-8')
    srid_converted = _ffi.cast('int32_t', srid)
    result = _lib.point_transform_pipeline(gs_converted, pipelinestr_converted, srid_converted, is_forward)
    _check_error()
    return result if result != _ffi.NULL else None
...
def set_split_each_n_spans(s: 'const Set *', elem_count: int) -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast('const Set *', s)
    count = _ffi.new('int *')
...
def spanset_split_each_n_spans(ss: 'const SpanSet *', elem_count: int) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    count = _ffi.new('int *')
...
def spanset_split_n_spans(ss: 'const SpanSet *', span_count: int) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    count = _ffi.new('int *')
...
def timestamptz_tprecision(t: int, duration: 'const Interval *', torigin: int) -> 'TimestampTz':
    t_converted = _ffi.cast('TimestampTz', t)
...
def tstzset_shift_scale(s: 'const Set *', shift: "Optional['const Interval *']", duration: "Optional['const Interval *']") -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
...
def tstzset_tprecision(s: 'const Set *', duration: 'const Interval *', torigin: int) -> 'Set *':
    s_converted = _ffi.cast('const Set *', s)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
...
def tstzspan_shift_scale(s: 'const Span *', shift: "Optional['const Interval *']", duration: "Optional['const Interval *']") -> 'Span *':
    s_converted = _ffi.cast('const Span *', s)
    shift_converted = _ffi.cast('const Interval *', shift) if shift is not None else _ffi.NULL
    duration_converted = _ffi.cast('const Interval *', duration) if duration is not None else _ffi.NULL
...
def tstzspan_tprecision(s: 'const Span *', duration: 'const Interval *', torigin: int) -> 'Span *':
    s_converted = _ffi.cast('const Span *', s)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
...
def tstzspanset_shift_scale(ss: 'const SpanSet *', shift: "Optional['const Interval *']", duration: "Optional['const Interval *']") -> 'SpanSet *':
    ss_converted = _ffi.cast('const SpanSet *', ss)
    shift_converted = _ffi.cast('const Interval *', shift) if shift is not None else _ffi.NULL
    duration_converted = _ffi.cast('const Interval *', duration) if duration is not None else _ffi.NULL
...
def tstzspanset_tprecision(ss: 'const SpanSet *', duration: 'const Interval *', torigin: int) -> 'SpanSet *':
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
...
def distance_bigintspanset_bigintspan(ss: 'const SpanSet *', s: 'const Span *') -> 'int64':
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def distance_bigintspanset_bigintspanset(ss1: 'const SpanSet *', ss2: 'const SpanSet *') -> 'int64':
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def distance_datespanset_datespanset(ss1: 'const SpanSet *', ss2: 'const SpanSet *') -> 'int':
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def distance_floatspanset_floatspan(ss: 'const SpanSet *', s: 'const Span *') -> 'double':
    ss_converted = _ffi.cast('const SpanSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def distance_floatspanset_floatspanset(ss1: 'const SpanSet *', ss2: 'const SpanSet *') -> 'double':
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def distance_intspanset_intspanset(ss1: 'const SpanSet *', ss2: 'const SpanSet *') -> 'int':
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def distance_tstzspanset_tstzspanset(ss1: 'const SpanSet *', ss2: 'const SpanSet *') -> 'double':
    ss1_converted = _ffi.cast('const SpanSet *', ss1)
    ss2_converted = _ffi.cast('const SpanSet *', ss2)
...
def stbox_make(hasx: bool, hasz: bool, geodetic: bool, srid: int, xmin: float, xmax: float, ymin: float, ymax: float, zmin: float, zmax: float, s: "Optional['const Span *']") -> 'STBox *':
...
def stbox_srid(box: 'const STBox *') -> 'int32_t':
    box_converted = _ffi.cast('const STBox *', box)
...
def stbox_set_srid(box: 'const STBox *', srid: 'int32_t') -> 'STBox *':
    box_converted = _ffi.cast('const STBox *', box)
    srid_converted = _ffi.cast('int32_t', srid)
...
def stbox_transform(box: 'const STBox *', srid: 'int32_t') -> 'STBox *':
    box_converted = _ffi.cast('const STBox *', box)
    srid_converted = _ffi.cast('int32_t', srid)
...
def stbox_transform_pipeline(box: 'const STBox *', pipelinestr: str, srid: 'int32_t', is_forward: bool) -> 'STBox *':
    box_converted = _ffi.cast('const STBox *', box)
    pipelinestr_converted = pipelinestr.encode('utf-8')
    srid_converted = _ffi.cast('int32_t', srid)
...
def tboolseqset_from_base_tstzspanset(b: bool, ss: 'const SpanSet *') -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tfloatseq_from_base_tstzspan(d: float, s: 'const Span *', interp: 'interpType') -> 'TSequence *':
    s_converted = _ffi.cast('const Span *', s)
...
def tfloatseqset_from_base_tstzspanset(d: float, ss: 'const SpanSet *', interp: 'interpType') -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const SpanSet *', ss)
    interp_converted = _ffi.cast('interpType', interp)
...
def tpointseq_from_base_tstzspan(gs: 'const GSERIALIZED *', s: 'const Span *', interp: 'interpType') -> 'TSequence *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    s_converted = _ffi.cast('const Span *', s)
    interp_converted = _ffi.cast('interpType', interp)
    result = _lib.tpointseq_from_base_tstzspan(gs_converted, s_converted, interp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tpointseq_from_base_tstzset(gs: 'const GSERIALIZED *', s: 'const Set *') -> 'TSequence *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    s_converted = _ffi.cast('const Set *', s)
...
def tpointseqset_from_base_tstzspanset(gs: 'const GSERIALIZED *', ss: 'const SpanSet *', interp: 'interpType') -> 'TSequenceSet *':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    ss_converted = _ffi.cast('const SpanSet *', ss)
    interp_converted = _ffi.cast('interpType', interp)
    result = _lib.tpointseqset_from_base_tstzspanset(gs_converted, ss_converted, interp_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tsequenceset_make_gaps(instants: 'const TInstant **', interp: 'interpType', maxt: "Optional['const Interval *']", maxdist: float) -> 'TSequenceSet *':
    instants_converted = [_ffi.cast('const TInstant *', x) for x in instants]
    interp_converted = _ffi.cast('interpType', interp)
    maxt_converted = _ffi.cast('const Interval *', maxt) if maxt is not None else _ffi.NULL
    result = _lib.tsequenceset_make_gaps(instants_converted, len(instants), interp_converted, maxt_converted, maxdist)
    _check_error()
    return result if result != _ffi.NULL else None
...
def ttextseqset_from_base_tstzspanset(txt: str, ss: 'const SpanSet *') -> 'TSequenceSet *':
    txt_converted = cstring2text(txt)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tbool_value_at_timestamptz(temp: 'const Temporal *', t: int, strict: bool) -> 'bool':
    temp_converted = _ffi.cast('const Temporal *', temp)
    t_converted = _ffi.cast('TimestampTz', t)
    out_result = _ffi.new('bool *')
...
def tfloat_value_at_timestamptz(temp: 'const Temporal *', t: int, strict: bool) -> 'double':
    temp_converted = _ffi.cast('const Temporal *', temp)
    t_converted = _ffi.cast('TimestampTz', t)
    out_result = _ffi.new('double *')
...
def tpoint_value_at_timestamptz(temp: 'const Temporal *', t: int, strict: bool) -> 'GSERIALIZED **':
    temp_converted = _ffi.cast('const Temporal *', temp)
    t_converted = _ffi.cast('TimestampTz', t)
    out_result = _ffi.new('GSERIALIZED **')
    result = _lib.tpoint_value_at_timestamptz(temp_converted, t_converted, strict, out_result)
    _check_error()
    if result:
        return out_result if out_result != _ffi.NULL else None
    return None
...
def ttext_value_at_timestamptz(temp: 'const Temporal *', t: int, strict: bool) -> 'text **':
    temp_converted = _ffi.cast('const Temporal *', temp)
    t_converted = _ffi.cast('TimestampTz', t)
    out_result = _ffi.new('text **')
...
def meos_srid_is_latlong(srid: 'int32_t') -> 'bool':
    srid_converted = _ffi.cast('int32_t', srid)
    result = _lib.meos_srid_is_latlong(srid_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def temporal_to_tsequenceset(temp: 'const Temporal *', interp_str: str) -> 'TSequenceSet *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    interp_str_converted = interp_str.encode('utf-8')
...
def tpoint_transform_pipeline(temp: 'const Temporal *', pipelinestr: str, srid: int, is_forward: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    pipelinestr_converted = pipelinestr.encode('utf-8')
    srid_converted = _ffi.cast('int32', srid)
    result = _lib.tpoint_transform_pipeline(temp_converted, pipelinestr_converted, srid_converted, is_forward)
    _check_error()
    return result if result != _ffi.NULL else None


def tpoint_transform_pj(temp: 'const Temporal *', srid: int, pj: 'const LWPROJ *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    srid_converted = _ffi.cast('int32', srid)
...
def temporal_append_tinstant(temp: 'Temporal *', inst: 'const TInstant *', maxdist: float, maxt: "Optional['const Interval *']", expand: bool) -> 'Temporal *':
...
def temporal_delete_tstzspan(temp: 'const Temporal *', s: 'const Span *', connect: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def temporal_delete_tstzspanset(temp: 'const Temporal *', ss: 'const SpanSet *', connect: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def temporal_delete_timestamptz(temp: 'const Temporal *', t: int, connect: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    t_converted = _ffi.cast('TimestampTz', t)
...
def temporal_delete_tstzset(temp: 'const Temporal *', s: 'const Set *', connect: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def temporal_at_tstzspanset(temp: 'const Temporal *', ss: 'const SpanSet *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def temporal_minus_tstzspan(temp: 'const Temporal *', s: 'const Span *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def temporal_minus_tstzspanset(temp: 'const Temporal *', ss: 'const SpanSet *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tpoint_at_geom(temp: 'const Temporal *', gs: 'const GSERIALIZED *', zspan: 'const Span *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def tpoint_minus_geom(temp: 'const Temporal *', gs: 'const GSERIALIZED *', zspan: 'const Span *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
...
def always_eq_point_tpoint(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_eq_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_eq_tpoint_point(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def always_eq_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_point_tpoint(gs: 'const GSERIALIZED *', temp: 'const Temporal *') -> 'int':
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def always_ne_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ne_tpoint_point(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def always_ne_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_ge_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_gt_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_le_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def always_lt_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_eq_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ge_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_gt_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_le_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_lt_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_temporal_temporal(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def ever_ne_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def temporal_split_each_n_spans(temp: 'const Temporal *', elem_count: int) -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def temporal_split_n_spans(temp: 'const Temporal *', span_count: int) -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tnumber_split_each_n_tboxes(temp: 'const Temporal *', elem_count: int) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tnumber_split_n_tboxes(temp: 'const Temporal *', box_count: int) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tpoint_space_boxes(temp: 'const Temporal *', xsize: float, ysize: float, zsize: float, sorigin: 'const GSERIALIZED *', bitmatrix: bool, border_inc: bool) -> "Tuple['STBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    count = _ffi.new('int *')
    result = _lib.tpoint_space_boxes(temp_converted, xsize, ysize, zsize, sorigin_converted, bitmatrix, border_inc, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def tpoint_space_time_boxes(temp: 'const Temporal *', xsize: float, ysize: float, zsize: float, duration: 'const Interval *', sorigin: 'const GSERIALIZED *', torigin: int, bitmatrix: bool, border_inc: bool) -> "Tuple['STBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
    result = _lib.tpoint_space_time_boxes(temp_converted, xsize, ysize, zsize, duration_converted, sorigin_converted, torigin_converted, bitmatrix, border_inc, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def tpoint_split_each_n_stboxes(temp: 'const Temporal *', elem_count: int) -> "Tuple['STBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tpoint_split_n_stboxes(temp: 'const Temporal *', box_count: int) -> "Tuple['STBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def geo_split_each_n_gboxes(gs: 'const GSERIALIZED *', elem_count: int) -> "Tuple['GBOX *', 'int']":
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    count = _ffi.new('int *')
...
def geo_split_n_gboxes(gs: 'const GSERIALIZED *', box_count: int) -> "Tuple['GBOX *', 'int']":
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    count = _ffi.new('int *')
...
def adjacent_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def adjacent_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contained_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contained_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contains_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def contains_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overlaps_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overlaps_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def same_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def after_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def before_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def before_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def left_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overabove_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overafter_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overafter_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overback_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overbefore_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overbefore_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overbelow_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overfront_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overleft_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overleft_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overright_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def overright_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def right_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'bool':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tpoint_srid(temp: 'const Temporal *') -> 'int32_t':
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tpoint_set_srid(temp: 'const Temporal *', srid: 'int32_t') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    srid_converted = _ffi.cast('int32_t', srid)
...
def tpoint_tfloat_to_geomeas(tpoint: 'const Temporal *', measure: 'const Temporal *', segmentize: bool) -> 'GSERIALIZED **':
...
def adisjoint_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def adwithin_tpoint_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *', dist: float) -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def adwithin_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *', dist: float) -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def aintersects_tpoint_geo(temp: 'const Temporal *', gs: 'const GSERIALIZED *') -> 'int':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
...
def aintersects_tpoint_tpoint(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'int':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tfloat_wmax_transfn(state: 'SkipList *', temp: 'const Temporal *', interv: 'const Interval *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def tfloat_wmin_transfn(state: 'SkipList *', temp: 'const Temporal *', interv: 'const Interval *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def tfloat_wsum_transfn(state: 'SkipList *', temp: 'const Temporal *', interv: 'const Interval *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def tint_wmax_transfn(state: 'SkipList *', temp: 'const Temporal *', interv: 'const Interval *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def tint_wmin_transfn(state: 'SkipList *', temp: 'const Temporal *', interv: 'const Interval *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def tint_wsum_transfn(state: 'SkipList *', temp: 'const Temporal *', interv: 'const Interval *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def tnumber_wavg_transfn(state: 'SkipList *', temp: 'const Temporal *', interv: 'const Interval *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state)
    temp_converted = _ffi.cast('const Temporal *', temp)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def tstzset_tcount_transfn(state: "Optional['SkipList *']", s: 'const Set *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    s_converted = _ffi.cast('const Set *', s)
...
def tstzspan_tcount_transfn(state: "Optional['SkipList *']", s: 'const Span *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    s_converted = _ffi.cast('const Span *', s)
...
def tstzspanset_tcount_transfn(state: "Optional['SkipList *']", ss: 'const SpanSet *') -> 'SkipList *':
    state_converted = _ffi.cast('SkipList *', state) if state is not None else _ffi.NULL
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def temporal_tsample(temp: 'const Temporal *', duration: 'const Interval *', origin: int, interp: 'interpType') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    origin_converted = _ffi.cast('TimestampTz', origin)
    interp_converted = _ffi.cast('interpType', interp)
    result = _lib.temporal_tsample(temp_converted, duration_converted, origin_converted, interp_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def bigintspan_bins(s: 'const Span *', vsize: int, vorigin: int) -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast('const Span *', s)
    vsize_converted = _ffi.cast('int64', vsize)
    vorigin_converted = _ffi.cast('int64', vorigin)
    count = _ffi.new('int *')
...
def bigintspanset_bins(ss: 'const SpanSet *', vsize: int, vorigin: int) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    vsize_converted = _ffi.cast('int64', vsize)
    vorigin_converted = _ffi.cast('int64', vorigin)
    count = _ffi.new('int *')
...
def bigintspanset_value_spans(ss: 'const SpanSet *', vsize: int, vorigin: int) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    vsize_converted = _ffi.cast('int64', vsize)
    vorigin_converted = _ffi.cast('int64', vorigin)
    count = _ffi.new('int *')
    result = _lib.bigintspanset_value_spans(ss_converted, vsize_converted, vorigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def date_get_bin(d: 'DateADT', duration: 'const Interval *', torigin: 'DateADT') -> 'DateADT':
    d_converted = _ffi.cast('DateADT', d)
    duration_converted = _ffi.cast('const Interval *', duration)
...
def datespan_bins(s: 'const Span *', duration: 'const Interval *', torigin: 'DateADT') -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast('const Span *', s)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('DateADT', torigin)
    count = _ffi.new('int *')
...
def datespanset_bins(ss: 'const SpanSet *', duration: 'const Interval *', torigin: 'DateADT') -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('DateADT', torigin)
    count = _ffi.new('int *')
...
def datespanset_time_spans(ss: 'const SpanSet *', duration: 'const Interval *', torigin: 'DateADT') -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('DateADT', torigin)
    count = _ffi.new('int *')
    result = _lib.datespanset_time_spans(ss_converted, duration_converted, torigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]
...
def floatspan_bins(s: 'const Span *', vsize: float, vorigin: float) -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast('const Span *', s)
    count = _ffi.new('int *')
...
def floatspanset_bins(ss: 'const SpanSet *', vsize: float, vorigin: float) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    count = _ffi.new('int *')
...
def floatspanset_value_spans(ss: 'const SpanSet *', vsize: float, vorigin: float) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    count = _ffi.new('int *')
...
def intspan_bins(s: 'const Span *', vsize: int, vorigin: int) -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast('const Span *', s)
    count = _ffi.new('int *')
...
def intspanset_bins(ss: 'const SpanSet *', vsize: int, vorigin: int) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    count = _ffi.new('int *')
...
def intspanset_value_spans(ss: 'const SpanSet *', vsize: int, vorigin: int) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    count = _ffi.new('int *')
...
def timestamptz_get_bin(t: int, duration: 'const Interval *', torigin: int) -> 'TimestampTz':
    t_converted = _ffi.cast('TimestampTz', t)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
...
def tstzspan_bins(s: 'const Span *', duration: 'const Interval *', origin: int) -> "Tuple['Span *', 'int']":
    s_converted = _ffi.cast('const Span *', s)
    duration_converted = _ffi.cast('const Interval *', duration)
    origin_converted = _ffi.cast('TimestampTz', origin)
    count = _ffi.new('int *')
...
def tstzspanset_bins(ss: 'const SpanSet *', duration: 'const Interval *', torigin: int) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
...
def tstzspanset_time_spans(ss: 'const SpanSet *', duration: 'const Interval *', torigin: int) -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
    result = _lib.tstzspanset_time_spans(ss_converted, duration_converted, torigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def stbox_get_space_tile(point: 'const GSERIALIZED *', xsize: float, ysize: float, zsize: float, sorigin: 'const GSERIALIZED *') -> 'STBox *':
...
def stbox_get_space_time_tile(point: 'const GSERIALIZED *', t: int, xsize: float, ysize: float, zsize: float, duration: 'const Interval *', sorigin: 'const GSERIALIZED *', torigin: int) -> 'STBox *':
    point_converted = _ffi.cast('const GSERIALIZED *', point)
    t_converted = _ffi.cast('TimestampTz', t)
    duration_converted = _ffi.cast('const Interval *', duration)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
...
def stbox_get_time_tile(t: int, duration: 'const Interval *', torigin: int) -> 'STBox *':
    t_converted = _ffi.cast('TimestampTz', t)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
...
def stbox_space_tiles(bounds: 'const STBox *', xsize: float, ysize: float, zsize: float, sorigin: 'const GSERIALIZED *', border_inc: bool) -> "Tuple['STBox *', 'int']":
    bounds_converted = _ffi.cast('const STBox *', bounds)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    count = _ffi.new('int *')
...
def stbox_space_time_tiles(bounds: 'const STBox *', xsize: float, ysize: float, zsize: float, duration: "Optional['const Interval *']", sorigin: 'const GSERIALIZED *', torigin: int, border_inc: bool) -> "Tuple['STBox *', 'int']":
    bounds_converted = _ffi.cast('const STBox *', bounds)
    duration_converted = _ffi.cast('const Interval *', duration) if duration is not None else _ffi.NULL
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
...
def stbox_time_tiles(bounds: 'const STBox *', duration: 'const Interval *', torigin: int, border_inc: bool) -> "Tuple['STBox *', 'int']":
    bounds_converted = _ffi.cast('const STBox *', bounds)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
...
def temporal_time_spans(temp: 'const Temporal *', duration: 'const Interval *', origin: int) -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    origin_converted = _ffi.cast('TimestampTz', origin)
    count = _ffi.new('int *')
    result = _lib.temporal_time_spans(temp_converted, duration_converted, origin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def temporal_time_split(temp: 'const Temporal *', duration: 'const Interval *', torigin: int) -> "Tuple['Temporal **', 'TimestampTz *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
...
def tfloat_value_spans(temp: 'const Temporal *', vsize: float, vorigin: float) -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tfloat_value_split(temp: 'const Temporal *', vsize: float, vorigin: float) -> "Tuple['Temporal **', 'double *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tfloat_value_time_split(temp: 'const Temporal *', vsize: float, duration: 'const Interval *', vorigin: float, torigin: int) -> "Tuple['Temporal **', 'double *', 'TimestampTz *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    value_bins = _ffi.new('double **')
...
def tfloatbox_get_time_tile(t: int, duration: 'const Interval *', torigin: int) -> 'TBox *':
    t_converted = _ffi.cast('TimestampTz', t)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    result = _lib.tfloatbox_get_time_tile(t_converted, duration_converted, torigin_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tfloatbox_get_value_time_tile(value: float, t: int, vsize: float, duration: 'const Interval *', vorigin: float, torigin: int) -> 'TBox *':
    t_converted = _ffi.cast('TimestampTz', t)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    result = _lib.tfloatbox_get_value_time_tile(value, t_converted, vsize, duration_converted, vorigin, torigin_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tfloatbox_time_tiles(box: 'const TBox *', duration: 'const Interval *', torigin: int) -> "Tuple['TBox *', 'int']":
    box_converted = _ffi.cast('const TBox *', box)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
...
def tfloatbox_value_tiles(box: 'const TBox *', vsize: float, vorigin: float) -> "Tuple['TBox *', 'int']":
    box_converted = _ffi.cast('const TBox *', box)
    count = _ffi.new('int *')
...
def tfloatbox_value_time_tiles(box: 'const TBox *', vsize: float, duration: 'const Interval *', vorigin: float, torigin: "Optional[int]") -> "Tuple['TBox *', 'int']":
    box_converted = _ffi.cast('const TBox *', box)
    duration_converted = _ffi.cast('const Interval *', duration)
...
def timestamptz_get_bin(timestamp: int, duration: 'const Interval *', torigin: int) -> 'TimestampTz':
    timestamp_converted = _ffi.cast('TimestampTz', timestamp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    result = _lib.timestamptz_get_bin(timestamp_converted, duration_converted, torigin_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tint_value_spans(temp: 'const Temporal *', vsize: int, vorigin: int) -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    count = _ffi.new('int *')
...
def tint_value_split(temp: 'const Temporal *', vsize: int, vorigin: int) -> "Tuple['Temporal **', 'int *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
...
def tint_value_time_split(temp: 'const Temporal *', size: int, duration: 'const Interval *', vorigin: int, torigin: int) -> "Tuple['Temporal **', 'int *', 'TimestampTz *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    value_bins = _ffi.new('int **')
...
def tintbox_get_time_tile(t: int, duration: 'const Interval *', torigin: int) -> 'TBox *':
    t_converted = _ffi.cast('TimestampTz', t)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    result = _lib.tintbox_get_time_tile(t_converted, duration_converted, torigin_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tintbox_get_value_time_tile(value: int, t: int, vsize: int, duration: 'const Interval *', vorigin: int, torigin: int) -> 'TBox *':
    t_converted = _ffi.cast('TimestampTz', t)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    result = _lib.tintbox_get_value_time_tile(value, t_converted, vsize, duration_converted, vorigin, torigin_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tintbox_time_tiles(box: 'const TBox *', duration: 'const Interval *', torigin: int) -> "Tuple['TBox *', 'int']":
    box_converted = _ffi.cast('const TBox *', box)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
...
def tintbox_value_tiles(box: 'const TBox *', xsize: int, xorigin: int) -> "Tuple['TBox *', 'int']":
    box_converted = _ffi.cast('const TBox *', box)
    count = _ffi.new('int *')
...
def tintbox_value_time_tiles(box: 'const TBox *', xsize: int, duration: 'const Interval *', xorigin: 'Optional[int]', torigin: "Optional[int]") -> "Tuple['TBox *', 'int']":
    box_converted = _ffi.cast('const TBox *', box)
    duration_converted = _ffi.cast('const Interval *', duration)
...
def tpoint_space_split(temp: 'const Temporal *', xsize: float, ysize: float, zsize: float, sorigin: 'const GSERIALIZED *', bitmatrix: bool, border_inc: bool) -> "Tuple['Temporal **', 'GSERIALIZED ***', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    space_bins = _ffi.new('GSERIALIZED ***')
    count = _ffi.new('int *')
    result = _lib.tpoint_space_split(temp_converted, xsize, ysize, zsize, sorigin_converted, bitmatrix, border_inc, space_bins, count)
    _check_error()
    return result if result != _ffi.NULL else None, space_bins[0], count[0]


def tpoint_space_time_split(temp: 'const Temporal *', xsize: float, ysize: float, zsize: float, duration: 'const Interval *', sorigin: 'const GSERIALIZED *', torigin: int, bitmatrix: bool, border_inc: bool) -> "Tuple['Temporal **', 'GSERIALIZED ***', 'TimestampTz *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    sorigin_converted = _ffi.cast('const GSERIALIZED *', sorigin)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    ...
    time_bins = _ffi.new('TimestampTz **')
    count = _ffi.new('int *')
    result = _lib.tpoint_space_time_split(temp_converted, xsize, ysize, zsize, duration_converted, sorigin_converted, torigin_converted, bitmatrix, border_inc, space_bins, time_bins, count)
    _check_error()
    return result if result != _ffi.NULL else None, space_bins[0], time_bins[0], count[0]


def tpoint_time_split(temp: 'const Temporal *', duration: 'const Interval *', torigin: int, border_inc: bool, time_bins: 'TimestampTz **') -> "Tuple['Temporal **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    time_bins_converted = [_ffi.cast('TimestampTz *', x) for x in time_bins]
    count = _ffi.new('int *')
    result = _lib.tpoint_time_split(temp_converted, duration_converted, torigin_converted, border_inc, time_bins_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]
...
def set_make(values: 'const Datum *', count: int, basetype: 'meosType', order: bool) -> 'Set *':
...
def set_make_exp(values: 'const Datum *', count: int, maxcount: int, basetype: 'meosType', order: bool) -> 'Set *':
    values_converted = _ffi.cast('const Datum *', values)
    basetype_converted = _ffi.cast('meosType', basetype)
...
def set_make_free(values: 'Datum *', count: int, basetype: 'meosType', order: bool) -> 'Set *':
...
def span_set(lower: 'Datum', upper: 'Datum', lower_inc: bool, upper_inc: bool, basetype: 'meosType', spantype: 'meosType', s: 'Span *') -> None:
    lower_converted = _ffi.cast('Datum', lower)
    upper_converted = _ffi.cast('Datum', upper)
    basetype_converted = _ffi.cast('meosType', basetype)
    spantype_converted = _ffi.cast('meosType', spantype)
...
def spanset_make_exp(spans: 'Span *', count: int, maxcount: int, normalize: bool, order: bool) -> 'SpanSet *':
...
def spanset_make_free(spans: 'Span *', count: int, normalize: bool, order: bool) -> 'SpanSet *':
    spans_converted = _ffi.cast('Span *', spans)
...
def spanbase_extent_transfn(state: 'Span *', value: 'Datum', basetype: 'meosType') -> 'Span *':
    state_converted = _ffi.cast('Span *', state)
    value_converted = _ffi.cast('Datum', value)
    basetype_converted = _ffi.cast('meosType', basetype)
...
def value_union_transfn(state: 'Set *', value: 'Datum', basetype: 'meosType') -> 'Set *':
    state_converted = _ffi.cast('Set *', state)
    value_converted = _ffi.cast('Datum', value)
    basetype_converted = _ffi.cast('meosType', basetype)
...
def number_tstzspan_to_tbox(d: 'Datum', basetype: 'meosType', s: 'const Span *') -> 'TBox *':
    d_converted = _ffi.cast('Datum', d)
    basetype_converted = _ffi.cast('meosType', basetype)
    s_converted = _ffi.cast('const Span *', s)
...
def stbox_set(hasx: bool, hasz: bool, geodetic: bool, srid: int, xmin: float, xmax: float, ymin: float, ymax: float, zmin: float, zmax: float, s: 'const Span *', box: 'STBox *') -> None:
    srid_converted = _ffi.cast('int32', srid)
    s_converted = _ffi.cast('const Span *', s)
...
def tpointseq_make_coords(xcoords: 'const double *', ycoords: 'const double *', zcoords: 'const double *', times: int, count: int, srid: int, geodetic: bool, lower_inc: bool, upper_inc: bool, linear: bool, normalize: bool) -> 'TSequence *':
    xcoords_converted = _ffi.cast('const double *', np.ascontiguousarray(xcoords, dtype=np.float64).ctypes.data)
    ycoords_converted = _ffi.cast('const double *', np.ascontiguousarray(ycoords, dtype=np.float64).ctypes.data)
    ...
    result = _lib.tpointseq_make_coords(xcoords_converted, ycoords_converted, zcoords_converted, times, count, srid, geodetic, lower_inc, upper_inc, linear, normalize)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tsequence_from_base_tstzset(value: 'Datum', temptype: 'meosType', ss: 'const Set *') -> 'TSequence *':
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('meosType', temptype)
    ss_converted = _ffi.cast('const Set *', ss)
    result = _lib.tsequence_from_base_tstzset(value_converted, temptype_converted, ss_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tsequence_from_base_tstzspan(value: 'Datum', temptype: 'meosType', s: 'const Span *', interp: 'interpType') -> 'TSequence *':
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('meosType', temptype)
    s_converted = _ffi.cast('const Span *', s)
    interp_converted = _ffi.cast('interpType', interp)
    result = _lib.tsequence_from_base_tstzspan(value_converted, temptype_converted, s_converted, interp_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tsequenceset_from_base_tstzspanset(value: 'Datum', temptype: 'meosType', ss: 'const SpanSet *', interp: 'interpType') -> 'TSequenceSet *':
    value_converted = _ffi.cast('Datum', value)
    temptype_converted = _ffi.cast('meosType', temptype)
    ss_converted = _ffi.cast('const SpanSet *', ss)
    interp_converted = _ffi.cast('interpType', interp)
    result = _lib.tsequenceset_from_base_tstzspanset(value_converted, temptype_converted, ss_converted, interp_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tsequence_value_at_timestamptz(seq: 'const TSequence *', t: int, strict: bool) -> 'Datum *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    t_converted = _ffi.cast('TimestampTz', t)
    out_result = _ffi.new('Datum *')
...
def tsequenceset_value_at_timestamptz(ss: 'const TSequenceSet *', t: int, strict: bool) -> 'Datum *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    t_converted = _ffi.cast('TimestampTz', t)
    out_result = _ffi.new('Datum *')
...
def temporal_tsequenceset(temp: 'const Temporal *', interp: 'interpType') -> 'TSequenceSet *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    interp_converted = _ffi.cast('interpType', interp)
...
def tinstant_shift_time(inst: 'const TInstant *', interv: 'const Interval *') -> 'TInstant *':
    inst_converted = _ffi.cast('const TInstant *', inst)
    interv_converted = _ffi.cast('const Interval *', interv)
...
def tinstant_to_tsequence_free(inst: 'TInstant *', interp: 'interpType') -> 'TSequence *':
...
def tsequence_append_tsequence(seq1: 'const TSequence *', seq2: 'const TSequence *', expand: bool) -> 'Temporal *':
...
def tsequence_delete_timestamptz(seq: 'const TSequence *', t: int, connect: bool) -> 'Temporal *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    t_converted = _ffi.cast('TimestampTz', t)
...
def tsequence_delete_tstzset(seq: 'const TSequence *', s: 'const Set *', connect: bool) -> 'Temporal *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    s_converted = _ffi.cast('const Set *', s)
...
def tsequence_delete_tstzspan(seq: 'const TSequence *', s: 'const Span *', connect: bool) -> 'Temporal *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    s_converted = _ffi.cast('const Span *', s)
...
def tsequence_delete_tstzspanset(seq: 'const TSequence *', ss: 'const SpanSet *', connect: bool) -> 'Temporal *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tsequenceset_delete_timestamptz(ss: 'const TSequenceSet *', t: int) -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    t_converted = _ffi.cast('TimestampTz', t)
...
def tsequenceset_delete_tstzset(ss: 'const TSequenceSet *', s: 'const Set *') -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Set *', s)
...
def tsequenceset_delete_tstzspan(ss: 'const TSequenceSet *', s: 'const Span *') -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def tsequenceset_delete_tstzspanset(ss: 'const TSequenceSet *', ps: 'const SpanSet *') -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
...
def tdiscseq_restrict_minmax(seq: 'const TSequence *', min: bool, atfunc: bool) -> 'TSequence *':
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def tcontseq_restrict_minmax(seq: 'const TSequence *', min: bool, atfunc: bool) -> 'TSequenceSet *':
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def temporal_restrict_timestamptz(temp: 'const Temporal *', t: int, atfunc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    t_converted = _ffi.cast('TimestampTz', t)
...
def temporal_restrict_tstzset(temp: 'const Temporal *', s: 'const Set *', atfunc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Set *', s)
...
def temporal_restrict_tstzspan(temp: 'const Temporal *', s: 'const Span *', atfunc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    s_converted = _ffi.cast('const Span *', s)
...
def temporal_restrict_tstzspanset(temp: 'const Temporal *', ss: 'const SpanSet *', atfunc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def temporal_value_at_timestamptz(temp: 'const Temporal *', t: int, strict: bool) -> 'Datum *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    t_converted = _ffi.cast('TimestampTz', t)
    out_result = _ffi.new('Datum *')
...
def tinstant_restrict_tstzspan(inst: 'const TInstant *', period: 'const Span *', atfunc: bool) -> 'TInstant *':
    inst_converted = _ffi.cast('const TInstant *', inst)
...
def tinstant_restrict_tstzspanset(inst: 'const TInstant *', ss: 'const SpanSet *', atfunc: bool) -> 'TInstant *':
    inst_converted = _ffi.cast('const TInstant *', inst)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tinstant_restrict_timestamptz(inst: 'const TInstant *', t: int, atfunc: bool) -> 'TInstant *':
    inst_converted = _ffi.cast('const TInstant *', inst)
    t_converted = _ffi.cast('TimestampTz', t)
...
def tinstant_restrict_tstzset(inst: 'const TInstant *', s: 'const Set *', atfunc: bool) -> 'TInstant *':
    inst_converted = _ffi.cast('const TInstant *', inst)
    s_converted = _ffi.cast('const Set *', s)
...
def tnpoint_restrict_geom(temp: 'const Temporal *', gs: 'const GSERIALIZED *', zspan: 'const Span *', atfunc: 'const bool') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
    atfunc_converted = _ffi.cast('const bool', atfunc)
    result = _lib.tnpoint_restrict_geom(temp_converted, gs_converted, zspan_converted, atfunc_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tnpoint_restrict_stbox(temp: 'const Temporal *', box: 'const STBox *', border_inc: bool, atfunc: bool) -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    box_converted = _ffi.cast('const STBox *', box)
    result = _lib.tnpoint_restrict_stbox(temp_converted, box_converted, border_inc, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None


def tpoint_restrict_geom(temp: 'const Temporal *', gs: 'const GSERIALIZED *', zspan: 'const Span *', atfunc: 'const bool') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
    atfunc_converted = _ffi.cast('const bool', atfunc)
    result = _lib.tpoint_restrict_geom(temp_converted, gs_converted, zspan_converted, atfunc_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tpointinst_restrict_geom(inst: 'const TInstant *', gs: 'const GSERIALIZED *', zspan: 'const Span *', atfunc: bool) -> 'TInstant *':
    inst_converted = _ffi.cast('const TInstant *', inst)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
    result = _lib.tpointinst_restrict_geom(inst_converted, gs_converted, zspan_converted, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tpointseq_restrict_geom(seq: 'const TSequence *', gs: 'const GSERIALIZED *', zspan: 'const Span *', atfunc: bool) -> 'Temporal *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
    result = _lib.tpointseq_restrict_geom(seq_converted, gs_converted, zspan_converted, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tpointseqset_restrict_geom(ss: 'const TSequenceSet *', gs: 'const GSERIALIZED *', zspan: 'const Span *', atfunc: bool) -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    gs_converted = _ffi.cast('const GSERIALIZED *', gs)
    zspan_converted = _ffi.cast('const Span *', zspan)
    result = _lib.tpointseqset_restrict_geom(ss_converted, gs_converted, zspan_converted, atfunc)
    _check_error()
    return result if result != _ffi.NULL else None
...
def tsequence_restrict_tstzspan(seq: 'const TSequence *', s: 'const Span *', atfunc: bool) -> 'Temporal *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    s_converted = _ffi.cast('const Span *', s)
...
def tsequence_restrict_tstzspanset(seq: 'const TSequence *', ss: 'const SpanSet *', atfunc: bool) -> 'Temporal *':
    seq_converted = _ffi.cast('const TSequence *', seq)
    ss_converted = _ffi.cast('const SpanSet *', ss)
...
def tsequenceset_restrict_tstzspan(ss: 'const TSequenceSet *', s: 'const Span *', atfunc: bool) -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Span *', s)
...
def tsequenceset_restrict_tstzspanset(ss: 'const TSequenceSet *', ps: 'const SpanSet *', atfunc: bool) -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    ps_converted = _ffi.cast('const SpanSet *', ps)
...
def tsequenceset_restrict_timestamptz(ss: 'const TSequenceSet *', t: int, atfunc: bool) -> 'Temporal *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    t_converted = _ffi.cast('TimestampTz', t)
...
def tsequenceset_restrict_tstzset(ss: 'const TSequenceSet *', s: 'const Set *', atfunc: bool) -> 'Temporal *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Set *', s)
...
def tsequenceset_restrict_values(ss: 'const TSequenceSet *', s: 'const Set *', atfunc: bool) -> 'TSequenceSet *':
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    s_converted = _ffi.cast('const Set *', s)
...
def nad_tnumber_tnumber(temp1: 'const Temporal *', temp2: 'const Temporal *') -> 'Datum':
    temp1_converted = _ffi.cast('const Temporal *', temp1)
    temp2_converted = _ffi.cast('const Temporal *', temp2)
...
def tpointseq_split_n_stboxes(seq: 'const TSequence *', max_count: int) -> "Tuple['STBox *', 'int']":
    seq_converted = _ffi.cast('const TSequence *', seq)
    count = _ffi.new('int *')
...
def tpointseqset_split_n_stboxes(ss: 'const TSequenceSet *', max_count: int) -> "Tuple['STBox *', 'int']":
    ss_converted = _ffi.cast('const TSequenceSet *', ss)
    count = _ffi.new('int *')
...
def tgeompoint_tnpoint(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tgeompoint_tnpoint(temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def tnpoint_tgeompoint(temp: 'const Temporal *') -> 'Temporal *':
    temp_converted = _ffi.cast('const Temporal *', temp)
    result = _lib.tnpoint_tgeompoint(temp_converted)
    _check_error()
    return result if result != _ffi.NULL else None
...
def temporal_app_tinst_transfn(state: 'Temporal *', inst: 'const TInstant *', maxdist: float, maxt: 'const Interval *') -> 'Temporal *':
    state_converted = _ffi.cast('Temporal *', state)
    inst_converted = _ffi.cast('const TInstant *', inst)
    maxt_converted = _ffi.cast('const Interval *', maxt)
    result = _lib.temporal_app_tinst_transfn(state_converted, inst_converted, maxdist, maxt_converted)
    _check_error()
    return result if result != _ffi.NULL else None


def temporal_app_tseq_transfn(state: 'Temporal *', seq: 'const TSequence *') -> 'Temporal *':
    state_converted = _ffi.cast('Temporal *', state)
    seq_converted = _ffi.cast('const TSequence *', seq)
...
def numspanset_spans(ss: 'const SpanSet *', vsize: 'Datum', vorigin: 'Datum') -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    vsize_converted = _ffi.cast('Datum', vsize)
    vorigin_converted = _ffi.cast('Datum', vorigin)
    count = _ffi.new('int *')
    result = _lib.numspanset_spans(ss_converted, vsize_converted, vorigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def spanset_time_spans(ss: 'const SpanSet *', duration: 'const Interval *', torigin: 'Datum') -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('Datum', torigin)
    count = _ffi.new('int *')
    result = _lib.spanset_time_spans(ss_converted, duration_converted, torigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def spanset_value_spans(ss: 'const SpanSet *', vsize: 'Datum', vorigin: 'Datum') -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    vsize_converted = _ffi.cast('Datum', vsize)
    vorigin_converted = _ffi.cast('Datum', vorigin)
    count = _ffi.new('int *')
    result = _lib.spanset_value_spans(ss_converted, vsize_converted, vorigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def timespanset_spans(ss: 'const SpanSet *', duration: 'const Interval *', torigin: 'Datum') -> "Tuple['Span *', 'int']":
    ss_converted = _ffi.cast('const SpanSet *', ss)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('Datum', torigin)
    count = _ffi.new('int *')
    result = _lib.timespanset_spans(ss_converted, duration_converted, torigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def tnumber_value_spans(temp: 'const Temporal *', size: 'Datum', origin: 'Datum') -> "Tuple['Span *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    size_converted = _ffi.cast('Datum', size)
    origin_converted = _ffi.cast('Datum', origin)
    count = _ffi.new('int *')
    result = _lib.tnumber_value_spans(temp_converted, size_converted, origin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def tnumber_value_boxes(temp: 'const Temporal *', vsize: 'Datum', vorigin: 'Datum') -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    vsize_converted = _ffi.cast('Datum', vsize)
    vorigin_converted = _ffi.cast('Datum', vorigin)
    count = _ffi.new('int *')
    result = _lib.tnumber_value_boxes(temp_converted, vsize_converted, vorigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def tnumber_time_boxes(temp: 'const Temporal *', duration: 'const Interval *', torigin: int) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    duration_converted = _ffi.cast('const Interval *', duration)
    torigin_converted = _ffi.cast('TimestampTz', torigin)
    count = _ffi.new('int *')
    result = _lib.tnumber_time_boxes(temp_converted, duration_converted, torigin_converted, count)
    _check_error()
    return result if result != _ffi.NULL else None, count[0]


def tnumber_value_time_boxes(temp: 'const Temporal *', vsize: 'Datum', duration: 'const Interval *', vorigin: 'Datum', torigin: int) -> "Tuple['TBox *', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    vsize_converted = _ffi.cast('Datum', vsize)
    duration_converted = _ffi.cast('const Interval *', duration)
    vorigin_converted = _ffi.cast('Datum', vorigin)
...
def tnumber_value_split(temp: 'const Temporal *', vsize: 'Datum', vorigin: 'Datum', bins: 'Datum **') -> "Tuple['Temporal **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    vsize_converted = _ffi.cast('Datum', vsize)
    vorigin_converted = _ffi.cast('Datum', vorigin)
...
def tbox_get_value_time_tile(value: 'Datum', t: int, vsize: 'Datum', duration: 'const Interval *', vorigin: 'Datum', torigin: int, basetype: 'meosType', spantype: 'meosType') -> 'TBox *':
    value_converted = _ffi.cast('Datum', value)
    t_converted = _ffi.cast('TimestampTz', t)
    vsize_converted = _ffi.cast('Datum', vsize)
    duration_converted = _ffi.cast('const Interval *', duration)
...
def tnumber_value_time_split(temp: 'const Temporal *', size: 'Datum', duration: 'const Interval *', vorigin: 'Datum', torigin: int, value_bins: 'Datum **', time_bins: 'TimestampTz **') -> "Tuple['Temporal **', 'int']":
    temp_converted = _ffi.cast('const Temporal *', temp)
    size_converted = _ffi.cast('Datum', size)
    duration_converted = _ffi.cast('const Interval *', duration)
    vorigin_converted = _ffi.cast('Datum', vorigin)
